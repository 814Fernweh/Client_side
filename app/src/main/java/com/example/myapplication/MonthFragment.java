...
/**
 * @programName: MonthFragment.java
 * @programFunction:
...
public class MonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sendSearchMonthRequestWithOkhttp(eID,1);
                ...
                switch (msg.what){
                    case 1:
                        adapter = new SimpleAdapter(getActivity()
                                , listitem
                                , R.layout.month_detail
                                ,new String[]{"checkdate","checkarrive", "checkleave"}
                                , new int[]{R.id.thedate,R.id.arrive, R.id.leave});
                        ...
                        // week.xml 里面
                        listView = (ListView) v.findViewById(R.id.monthdata);
    ...
    // month 就返回本月的
    public void sendSearchMonthRequestWithOkhttp(Integer eID,Integer flag) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String BaseURL = "http://192.168.1.102:8081/attendance/clientSearchMonthData";
                // 传给服务器端的参数
                ...
                try {
                    ...
                    RequestBody requestBody = new FormBody.Builder().add("SearchMonthData", data.toString()).build();
               ...
               //     System.out.println("map的值为:"+map);
                    ...
                    System.out.println("day0的值为:"+allmonth);
